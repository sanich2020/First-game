...
player = Play(100, screen_height - 130)
    ...
    if main_menu:
        ...
        if game_over == 0:
            ...
            if pygame.sprite.spritecollide(player, coin_group, True):
                score += 1
                coin_fx.play()
            txt('X ' + str(score), font_score, white, tile_size - 10, 10)
        ...
        if game_over == 1:
            ...
            if level <= max_levels:
                ...
                txt('YOU WIN!', font, blue, (screen_width // 2) - 140, screen_height // 2)
                if restart_button.draw():
                    level = 1
